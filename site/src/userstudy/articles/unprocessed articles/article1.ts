    ...
    paragraphContent: [
      ...
      },
      {
        ...
        unitSegmentSpec: {
          insightType: 'noType',
          segmentIdx: 1,
          context: 'This noType is largely projected to continue, though their shares will decrease:',
        },
      },
    ],
  },
    ...
    paragraphContent: [
      {
        ...
        unitSegmentSpec: {
          ...
          segmentIdx: 0,
          context:
            'The U.S. population overall is expected to noType older in the coming decades as life expectancies increase and the birth rate declines.',
        },
      },
      {
        id: 'p7s1',
